...
${OBJECTDIR}/Compiler/ControlEdge.o: Compiler/ControlEdge.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Compiler/ControlEdge.o Compiler/ControlEdge.cpp

${OBJECTDIR}/Compiler/Exchange.o: Compiler/Exchange.cpp 
	${MKDIR} -p ${OBJECTDIR}/Compiler
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Compiler/Exchange.o Compiler/Exchange.cpp

${OBJECTDIR}/Compiler/ExternalEdge.o: Compiler/ExternalEdge.cpp 
	${MKDIR} -p ${OBJECTDIR}/Compiler
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Compiler/ExternalEdge.o Compiler/ExternalEdge.cpp

${OBJECTDIR}/Compiler/Graph.o: Compiler/Graph.cpp 
	${MKDIR} -p ${OBJECTDIR}/Compiler
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Compiler/Graph.o Compiler/Graph.cpp

${OBJECTDIR}/Compiler/InternalEdge.o: Compiler/InternalEdge.cpp 
	${MKDIR} -p ${OBJECTDIR}/Compiler
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Compiler/InternalEdge.o Compiler/InternalEdge.cpp

${OBJECTDIR}/Compiler/StaticHelper.o: Compiler/StaticHelper.cpp 
	${MKDIR} -p ${OBJECTDIR}/Compiler
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Compiler/StaticHelper.o Compiler/StaticHelper.cpp

${OBJECTDIR}/Compiler/Subgraph.o: Compiler/Subgraph.cpp 
	${MKDIR} -p ${OBJECTDIR}/Compiler
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Compiler/Subgraph.o Compiler/Subgraph.cpp

${OBJECTDIR}/Compiler/Vertex.o: Compiler/Vertex.cpp 
	${MKDIR} -p ${OBJECTDIR}/Compiler
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Compiler/Vertex.o Compiler/Vertex.cpp

${OBJECTDIR}/Parser/HexParser.o: Parser/HexParser.cpp 
	${MKDIR} -p ${OBJECTDIR}/Parser
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Parser/HexParser.o Parser/HexParser.cpp

${OBJECTDIR}/Parser/Lexer.o: Parser/Lexer.cpp 
	${MKDIR} -p ${OBJECTDIR}/Parser
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Parser/Lexer.o Parser/Lexer.cpp

${OBJECTDIR}/Parser/Parser.o: Parser/Parser.cpp 
	${MKDIR} -p ${OBJECTDIR}/Parser
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Parser/Parser.o Parser/Parser.cpp

${OBJECTDIR}/Parser/Tag.o: Parser/Tag.cpp 
	${MKDIR} -p ${OBJECTDIR}/Parser
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Parser/Tag.o Parser/Tag.cpp
